  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrollY > 50
          ? "bg-background/10 backdrop-blur-xl text-black shadow"
          : `bg-transparent ${
              currentPath === "/sudut-profile-development"
                ? "text-white"
                : "text-black"
            }`
      }`}
    >
      ...
      {mobileOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2">
          <TransitionLink href="#home" className=" font-medium">
            HOME
          </TransitionLink>
          <TransitionLink href="#vehicles" className=" font-medium">
            VEHICLE FLEET
          </TransitionLink>
          <TransitionLink href="#services" className=" font-medium">
            SERVICES
          </TransitionLink>
          <TransitionLink href="#about-us" className=" font-medium">
            ABOUT US
          </TransitionLink>
          <TransitionLink href="#cta" className=" font-medium">
            CONTACT US
          </TransitionLink>
        </div>
      )}
