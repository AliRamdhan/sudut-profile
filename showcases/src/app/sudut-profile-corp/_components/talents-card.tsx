...
const TalentsCard = ({ talent }: TalentCardProps) => {
  return (
    <div className="relative w-full max-w-md mx-auto bg-gradient-to-br from-gray-200 to-gray-300 rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="relative h-[550px] group">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          ...
          <div className="flex justify-between items-center ">
            <div className="flex gap-4">
              ...
              <TransitionLink
                href={`#${talent.socialMedia.twitter}`}
                className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-colors"
                aria-label="Twitter"
              >
                <svg
        ...
        0 0 0 22.46 6z"
              ...
              <TransitionLink
                href={`#${talent.socialMedia.tiktok}`}
                className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-colors"
                aria-label="TikTok"
              >
                <svg
            ...
            <div>
              <TransitionLink href={`/sudut-profile-corp/talents/${talent.slug}`}>
                <Button
                  variant={"ghost"}
