  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-x-4 bottom-0 md:inset-[25%] z-40 bg-white dark:bg-zinc-900 rounded-t-xl md:rounded-xl overflow-hidden max-h-[80vh] md:max-h-[500px]"
      >
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start mb-2">
                <div className="text-left ">
                  ...
                  <p className="text-xl text-zinc-500 dark:text-zinc-400 mt-2.5">
