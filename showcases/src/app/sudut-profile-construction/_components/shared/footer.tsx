...
import { Building, ArrowRight, Mail, Phone, MapPin } from "lucide-react";

export function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-300 py-12 md:py-16 lg:py-20">
          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              <Input
                ...
                className="flex-1 rounded-r-none bg-gray-800 border-gray-700 text-white placeholder:text-gray-400"
              />
              <Button className="rounded-l-none bg-gray-700 hover:bg-gray-600">
