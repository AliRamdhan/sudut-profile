  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        <p className="max-w-3xl text-lg mx-auto text-gray-700 mb-12">
          Explore how Sudut Profile Construction can turn your vision into reality
          with our expertise and dedication to excellence.
        </p>
        <div className="flex justify-center items-center gap-x-8 mb-8">
          <TransitionLink href="#" target="_blank" rel="noopener noreferrer">
            <Button
