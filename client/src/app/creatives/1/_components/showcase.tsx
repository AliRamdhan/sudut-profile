...
interface ShowcaseProps {
  setIsHoveringDesignElement: (isHovering: boolean) => void;
}
const Showcase = ({ setIsHoveringDesignElement }: ShowcaseProps) => {
  return (
    <section
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-start lg:pr-16 mb-16 lg:mb-0">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-white/70 mb-8 md:mb-12 leading-relaxed">
              Drag and drop content into beautiful bento grid layouts. Create
              professional-looking designs in minutes, not hours.
            </p>
