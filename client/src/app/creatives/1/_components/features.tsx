      ...
      <div className="max-w-6xl mx-auto px-8 md:px-12 lg:px-16">
        <div className="mb-20 md:mb-28 max-w-3xl">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-white/70 leading-relaxed">
            Everything you need to create stunning bento grid layouts without
            learning or spending on a deisgn tool.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20 lg:gap-28">
            <article className="relative">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-white/70 leading-relaxed mb-8 md:mb-12">
                Automatically adapts to any screen size. Your bento grids look
            ...
            <article className="relative">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-white/70 leading-relaxed mb-8 md:mb-12">
                Add images, videos, text, and embed interactive content. Support
                for all major file formats and media types.
              </p>
            ...
            <article className="relative group">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-white/70 leading-relaxed mb-8 md:mb-12">
                Create unlimited content arrangements. Our smart algorithm
                automatically organizes your content beautifully.
              </p>
            ...
            <article className="relative">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-white/70 leading-relaxed mb-8 md:mb-12">
                Deploy your bento grid instantly to the web. Share your
                creations with custom URLs and SEO optimization.
              </p>
